...
@Component({
    ...
    providers: [ConstantService, CorsbootService]
})
...
constructor( private corsbootService: CorsbootService,
    private constantService: ConstantService,private completerService: CompleterService) { 
